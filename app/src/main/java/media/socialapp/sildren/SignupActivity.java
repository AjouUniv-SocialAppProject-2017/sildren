...
public class SignupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createAccount(final String email, String password, final String name, final String phoneNumber, final String birth ) {
...
//                        hideProgressDialog();
    ...
    private void addUserData(FirebaseUser user, String email, String name, String phoneNumber,  String birth ){

        UserData userData = new UserData();
        userData.userName = name;
        userData.userSex = 0;
        userData.userKey = user.getUid();
        userData.userPhoneNumber = phoneNumber;
        userData.userBirth = birth;
        userData.userEmail = email;
        mDatabaseReference.push().setValue(userData);
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.email_create_account_button) {
            createAccount(mEmailField.getText().toString(), mPasswordField.getText().toString(),
                    mNameField.getText().toString(), mPhoneNumberField.getText().toString(), mBirthField.getText().toString());
