...
import media.socialapp.sildren.DataModels.Distance;
import media.socialapp.sildren.DataModels.Duration;
import media.socialapp.sildren.DataModels.Route;


public class DirectionFinder {
    private static final String DIRECTION_URL_API = "https://maps.googleapis.com/maps/api/directions/json?";
    private static final String GOOGLE_API_KEY = "AIzaSyBjll9Cro-BivWa4MEgfTVQbaDUINajF1Q";
